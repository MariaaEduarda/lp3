...
// @author Radames
public class GUITipoImovelListagem extends JDialog {
    ...
    public GUITipoImovelListagem(List<TipoImovel> texto, int posX, int posY, Dimension dimensao) {
        setTitle("Listagem de TipoImovel");
        ...
        String[] colunas = new String[]{"idImovel",
"nomeTipoImovel",};
...
String[] linha = new String[]{String.valueOf(texto.get(i).getIdImovel()),
String.valueOf(texto.get(i).getNomeTipoImovel()),};
            model.addRow(linha);
        }
